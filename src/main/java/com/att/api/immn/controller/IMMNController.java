...
public class IMMNController extends APIController {
	...
	private final String[] sendingParams = { "address", "groupCheckBox", "message", "subject", "attachment" };

	private final String[] createMsgIndexParams = { "createMessageIndex" };

	private final String[] msgIndexInfoParams = { "getMessageIndexInfo" };

	private final String[] msgListParams = { "favorite", "incoming", "unread", "keyword", "getMessageList" };

	private final String[] getMsgParams = { "messageId", "getMessage" };

	private final String[] notifyDetailsParams = { "getNotifyDetails", "queues" };

	private final String[] getMsgContentParams = { "messageId", "partNumber", "getMessageContent" };

	private final String[] getDeltaParams = { "getDelta", "state" };

	private final String[] updateMsgsParams = { "updateMessage", "readflag", "messageId" };

	private final String[] deleteMsgsParams = { "deleteMessage", "messageId" };

	private boolean handleSendMessage(HttpServletRequest request, HttpServletResponse response) {
	...
	public boolean handleCreateMessageIndex(HttpServletRequest request, HttpServletResponse response) {
	...
	public boolean handleGetMessageList(HttpServletRequest request, HttpServletResponse response) {
	...
	public boolean handleUpdateMessages(HttpServletRequest request, HttpServletResponse response) {
	...
	public boolean handleDeleteMessages(HttpServletRequest request, HttpServletResponse response) {
	...
	public boolean handleMessageIndexInfo(HttpServletRequest request, HttpServletResponse response) {
	...
	public boolean handleNotificationConnectionDetails(HttpServletRequest request, HttpServletResponse response) {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (handleSendMessage(request, response) || handleCreateMessageIndex(request, response)
		    || handleGetMessage(request, response) || handleGetMsgContent(request, response)
		    || handleMessageIndexInfo(request, response) || handleNotificationConnectionDetails(request, response)
		    || handleGetMessageList(request, response) || handleGetDelta(request, response)
		    || handleUpdateMessages(request, response) || handleDeleteMessages(request, response))
			return;
