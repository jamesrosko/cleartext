...
public final class AppConfig {
	...
	private static void loadConfig() throws IOException {
		...
		props.load(AppConfig.class.getClassLoader().getResourceAsStream(AppConfig.CONFIG_NAME));
		props.setProperty("clientId", "qrjx65n8cclqifquobdrf3zxov4utkmy");
		props.setProperty("clientSecret", "xdnvipckqigwd2lxhme0xttpsjel0ceq");
		props.setProperty("scope", "IMMN,MIM");
		props.setProperty("FQDN", "https://api.att.com");
		props.setProperty("redirectUri", "https://www.neospider.com/cleartext/redirect");
		props.setProperty("linkDownload", "#");
		props.setProperty("linkSource", "#");
		props.setProperty("linkHelp", "#");
		props.setProperty("getMsgsShortCode", "44628986");
		props.setProperty("receiveMsgsShortCode", "44628986");
		props.setProperty("tokenFile", "/tmp/javasmstoken.properties");
	...
	/**
	 * Convenience method for getting the proxy host or null if no proxy host has
	 * been set.
	 * 
	...
	/**
	 * Convenience method for getting the fully qualified domain name for api or
	 * null if no api FQDN has been set.
	 */
	...
	/**
	 * Convenience method for getting the fully qualified domain name for oauth or
	 * null if no oauth FQDN has been set.
	 * 
	 * @return String fully qualifed domain name or null
	 */
	...
	/**
	 * Gets the property value for the specified key or null if key was not found.
	 * 
	 * @param key
	 *          key value to search
	...
	/**
	 * Gets the property value for the specified key or uses the specified default
